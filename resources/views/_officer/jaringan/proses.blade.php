...
<html lang="en">
  ...
  <body>
    ...
    {{-- Proses Pengaduan --}}
        <div class="col-md-6 ">
        <form class="mt-5" method="post" action="{{ route('admin.jaringan.proses.store', $pengaduan->kode) }}">
            @csrf
            <div class="col-5">
                @error('status')
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="status" id="flexRadioDefault1" value="Pengaduan Sedang Proses" onclick="show(1)"  > 
