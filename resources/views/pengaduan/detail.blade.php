...
<html lang="en">
  ...
  <div class="container mt-3">
    ...
    <div class="d-inline">
        ...
        <p class="card-text btn btn-primary">Tujuan : <strong>{{ $pengaduan->tujuan->nama }}</strong></p>
        <br>
        ...
        <div class="col-lg-6">
          ...
          <div class="nav-wrapper">
            <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
              ...
              @if($pengaduan->status == "Pengaduan Selesai" || $pengaduan->status == "Pengaduan Ditolak")
                <li class="nav-item">
                  <a class="nav-link mb-sm-3 mb-md-0" 
